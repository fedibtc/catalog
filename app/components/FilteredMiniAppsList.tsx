  ...
  if (miniApps.length === 0) {
    return (
      <Flex col align="center" gap={1}>
        ...
        <Text weight="bold" className="text-gray-500">No results found</Text>
        <Text className="text-gray-500 text-xs">There are no mini apps available for the selected filter</Text>
      </Flex>
    )
  } else {
    return (
